...
{
    public class FirebaseFirestorePostprocessor : AssetPostprocessor
    {
        private const string m_FileName = "Firebase.Firestore.dll";
        private const string m_Define = "USE_FIREBASE_FIRESTORE";
